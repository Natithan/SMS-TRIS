...
if __name__ == '__main__':
    ...
    add_id_ood_common_args(parser, from_ce=True)

    args, _ = parser.parse_known_args()
    if args.mini:
        print("Setting max epochs to 10 because of mini mode")
        args.max_epochs = 10
    ...
    train_dataset = DataClass(
        ...
        coarse_vars=False, img_width=args.data_img_width,mini=args.mini)
    val_dataset = DataClass(
        data_folder=args.data_dir, split='val', single_image=True, return_latents=True,
        causal_vars=train_dataset.target_names(), coarse_vars=False, img_width=args.data_img_width,mini=args.mini)
    ...
    data_name = os.path.basename(args.data_dir) # Nathan
    ...
    train_model(model_class=model_class,
                ...
                val_loaders_dict={'ce': val_loader},
